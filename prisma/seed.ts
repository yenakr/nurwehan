...
- 뚜껑이 있는 생수 또는 밀폐되는 텀블러를 제외한 음료(테이크아웃 컵 등)를 실습실 내 반입 및 섭취 금지합니다.
  ...
  // Seed Nursing Terms for 간호관리학 (category: 퀴즈 1) & 여성의부인과적장애와간호
  await prisma.nursingTerm.deleteMany({});
  const nursingTermsData = [
    { subject: '간호관리학', category: '퀴즈 1', term: '간호관리', englishTerm: 'nursing management', definition: '간호조직의 목표 달성을 위하여 간호인력과 모든 자원을 활용하여 기획, 조직, 인적자원관리, 지휘, 통제를 하는 전 과정을 말한다.' },
    { subject: '간호관리학', category: '퀴즈 1', term: '간호관리체계모형', englishTerm: null, definition: '간호관리과정을 체계이론 관점으로 보고, 투입, 변환과정, 산출, 피드백으로 구성한다. 즉, 투입요소들이 관리지원기능의 지원 하에 전환과정을 거친 후 산출요소로 생산되는 순환과정을 말한다.' },
    { subject: '간호관리학', category: '퀴즈 1', term: '효과', englishTerm: 'efficiency', definition: '목적, 결과, 대상, 대외지향적인 것, 장기적인 측정치와 관련된 개념으로 목표달성을 의미한다.' },
    { subject: '간호관리학', category: '퀴즈 1', term: '효율', englishTerm: 'effectiveness', definition: '수단, 과정, 방법, 대내지향적인 것, 단기적인 측정치와 관련된 개념으로 업무수행 과정에서의 투입과 산출의 비율을 의미한다.' },
    { subject: '간호관리학', category: '퀴즈 1', term: '간호관리자의 관리수준', englishTerm: null, definition: '관리자의 유형으로, 최고관리자, 중간관리자, 일선관리자로 구분한다.' },
    { subject: '간호관리학', category: '퀴즈 1', term: '과학적 관리론', englishTerm: 'scientific management', definition: '작업의 능률과 효율을 향상시키기 위한 방법에 과학적 원칙을 적용한 이론' },
    { subject: '간호관리학', category: '퀴즈 1', term: '행정관리이론', englishTerm: 'general administrative theory', definition: '전체로서의 조직관리에 초점을 두고 보편적 원리를 정립한 이론' },
    { subject: '간호관리학', category: '퀴즈 1', term: '관료제이론', englishTerm: 'bureaucratic management', definition: '조직의 질서, 체제, 합리성, 통합성, 일관성을 강조하는 조직의 원형이론' },
    { subject: '간호관리학', category: '퀴즈 1', term: '인간관계론', englishTerm: 'human relations approach', definition: '조직구성원이 심리적·사회적 욕구를 가진 사회적 존재라는 가정 하에 구성원에 대한 인간성 존중을 통해 생산성을 도모하려는 이론' },
    { subject: '간호관리학', category: '퀴즈 1', term: '행태과학론', englishTerm: 'behavioral science', definition: '조직 내에서 인간행동에 영향을 미치는 요인에 관한 지식을 체계화 한 이론' },
    { subject: '간호관리학', category: '퀴즈 1', term: '체계이론', englishTerm: 'system theory', definition: '환경과 상호작용하는 개방체계로서의 조직이 특정 목표를 달성하기 위해 투입, 변환, 산출, 환류로 구성되는 통합체로서 기능한다는 사실을 정립한 이론' },
    { subject: '간호관리학', category: '퀴즈 1', term: '상황이론', englishTerm: 'contingency theory', definition: '조직 외부의 환경, 조직 전체 시스템과 하위 시스템의 관계를 중시하며, 이러한 관계에 적합한 관리자의 능력·스타일을 찾아야 한다는 이론' },
    { subject: '간호관리학', category: '퀴즈 1', term: '재무관리', englishTerm: null, definition: '조직운영에 필요한 자금을 합리적으로 조달하고 그 자금을 효율적으로 운영하여 기업가치를 극대화하기 위한 의사결정을 수행하는 관리활동' },
    { subject: '간호관리학', category: '퀴즈 1', term: '대차대조표', englishTerm: null, definition: '일정 시점에서 그 기업의 재무상태를 표시하는 보고서' },
    { subject: '간호관리학', category: '퀴즈 1', term: '손익계산서', englishTerm: null, definition: '일정 기간에 기업의 경영성과를 나타내는 보고서, 당해기간에 발생한 모든 수익과 이에 대응되는 비용을 나타내는 재무보고서' },
    { subject: '간호관리학', category: '퀴즈 1', term: '현금흐름표', englishTerm: null, definition: '일정 기간에 현금이 어떻게 조달되고 사용되었는가를 보여주는 기본적 재무보고서' },
    { subject: '간호관리학', category: '퀴즈 1', term: '점진적 예산제', englishTerm: null, definition: '전 회계년도에서의 총 비용이 옳다는 가정 아래 전년도의 비용에 차기년도의 물가상승률이나 이자율을 곱하여 차기년도의 예산을 세우는 방법' },
    { subject: '간호관리학', category: '퀴즈 1', term: '영기준 예산제', englishTerm: 'zero-base', definition: '전 회계년도의 예산에 구애됨이 없이 조직체의 모든 사업과 활동에 대해 영기준(zero-base)을 적용해서 각각의 효율성과 효과성 및 중요성을 체계적으로 분석하고, 그에 따라 우선순위가 높은 사업·활동을 선택하여 실행예산을 결정하는 예산제도' },
    { subject: '간호관리학', category: '퀴즈 1', term: '운영예산', englishTerm: null, definition: '부서의 활동을 완수하기 위해 1년 이내에 소비하거나 사용할 서비스나 재화' },
    { subject: '간호관리학', category: '퀴즈 1', term: '상대가치수가제', englishTerm: null, definition: '진료항목 행위별 점수에 환산지수를 곱하여 총 진료비, 즉 수가를 책정하는 방식' },
    { subject: '간호관리학', category: '퀴즈 1', term: '포괄수가제', englishTerm: null, definition: '의료서비스의 양과 질에 관계없이 질병군(또는 환자군)별로 미리 책정된 정액진료비를 병의원에 지불하는 제도' },
    { subject: '간호관리학', category: '퀴즈 1', term: '신포괄수가제', englishTerm: null, definition: '입원 기간 동안 발생한 입원료, 처치 등 진료에 필요한 기본 서비스는 포괄수가로 묶고 의사의 수술, 시술 등은 행위별로 보상하는 제도' },
    { subject: '간호관리학', category: '퀴즈 1', term: '행위별수가제', englishTerm: null, definition: '개별 의료행위 각각에 수가를 산정하여 환자가 의료서비스를 많이 이용할수록 수가가 많이 부가되게 하는 방법' },
    { subject: '간호관리학', category: '퀴즈 1', term: '간호수가', englishTerm: null, definition: '간호사가 제공한 간호행위의 대가로 지불을 청구할 수 있는 금액' },
    { subject: '간호관리학', category: '퀴즈 1', term: '간호관리료', englishTerm: null, definition: '간호행위 중에서 개별 항목으로 수가화된 항목을 제외한 나머지 간호서비스에 대한 금액' },
    { subject: '간호관리학', category: '퀴즈 1', term: '간호관리료 차등제', englishTerm: null, definition: '간호인력 확보 수준에 따라 기본진료료 중 입원료를 차등 지급하는 제도' },
    { subject: '간호관리학', category: '퀴즈 1', term: '목표관리', englishTerm: 'management by objectives', definition: '조직의 상위관리자와 하위관리자들이 공동으로 목표를 설정하고 목표와 실제의 결과를 비교 통제하는 과정' },
    { subject: '간호관리학', category: '퀴즈 1', term: '의사결정', englishTerm: null, definition: '어떤 결정안에 이르는 사고 및 행동과정으로서 둘 이상의 문제해결 대안 중에서 의사결정자가 목적을 달성하는 데 가장 좋은 대안이라고 생각되는 것을 선택하는 행위' },
    { subject: '간호관리학', category: '퀴즈 1', term: '마케팅', englishTerm: 'marketing', definition: '개인과 조직들이 가치 창출 및 교환을 통해 자신들이 원하는 것을 얻기 위해 이루어지는 사회적·관리적 과정' },
    { subject: '간호관리학', category: '퀴즈 1', term: '서비스마케팅', englishTerm: 'service marketing', definition: '서비스란 특정한 소비자 욕구를 충족시키기 위해 제공되는 무형의 활동이며, 이러한 서비스가 고객의 기대와 욕구를 충족시킬 수 있도록 하는 일체의 활동' },
    { subject: '간호관리학', category: '퀴즈 1', term: '마케팅 믹스', englishTerm: 'marketing mix', definition: '마케팅을 목표로 효과적으로 달성하기 위한 도구들의 집합으로 제품(product), 가격(price), 유통(place), 촉진(promotion)의 4P로 불림' },
    { subject: '간호관리학', category: '퀴즈 1', term: '조직', englishTerm: 'organization', definition: '인간의 사회적, 개인적 목적을 달성하기 위한 집단의 모임' },
    { subject: '간호관리학', category: '퀴즈 1', term: '조직화', englishTerm: 'organizing', definition: '조직구성원들이 효과적으로 목표를 달성하도록 직무내용을 편성하고, 그 직무수행 에 필요한 권한 및 책임을 부여하며 조정해 가는 과정' },
    { subject: '간호관리학', category: '퀴즈 1', term: '통솔범위', englishTerm: 'span of control', definition: '관리자가 조직구성원을 효과적으로 관리할 수 있는 직원의 수' },
    { subject: '간호관리학', category: '퀴즈 1', term: '권력', englishTerm: 'power', definition: '어떤 개인이나 집단이 다른 개인 또는 집단의 형태에 영향을 미칠 수 있는 능력' },
    { subject: '간호관리학', category: '퀴즈 1', term: '권한', englishTerm: 'authority', definition: '조직의 규범에 의하여 합법성이 인정된 권력' },
    { subject: '간호관리학', category: '퀴즈 1', term: '위임', englishTerm: 'delegation', definition: '하위자에게 수행할 과업을 할당하고 그러한 과업수행 활동을 책임지는 데 필요한 재량권을 부여하는 것' },
    { subject: '간호관리학', category: '퀴즈 1', term: '집단', englishTerm: 'group', definition: '두 사람 이상이 모여 공동목표를 달성하기 위해 공통의 규범, 서로의 역할과 신분을 인정하고 상호작용하며, 유기적인 관계를 형성하는 개인들의 집합체' },
    { subject: '간호관리학', category: '퀴즈 1', term: '공식적 집단', englishTerm: 'formal group', definition: '조직 내에 지위, 부서, 계층 등을 가지고 형성된 집단으로 조직의 특정한 과업을 수행하기 위하여 이루어진 집단' },
    { subject: '간호관리학', category: '퀴즈 1', term: '비공식적 집단', englishTerm: 'informal group', definition: '조직 내에서 공식목표나 과업에 관계없이 자연적으로 형성된 집단' },
    { subject: '여성의부인과적장애와간호', category: '퀴즈 1', term: '자궁근종', englishTerm: 'Uterine Myoma', definition: '자궁 평활근에서 발생하는 가장 흔한 여성 생식기 평활근종 양성 튜머' },
    { subject: '여성의부인과적장애와간호', category: '퀴즈 1', term: '자궁내막증', englishTerm: 'Endometriosis', definition: '자궁내막 조직이 자궁 선강 외의 부위에 존재하여 통증 및 난임을 유발하는 질환' },
  ];
