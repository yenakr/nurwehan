        ...
        <div className="card">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginTop: '32px' }}>
            <div className="card" style={{ border: '1px solid var(--border)', textAlign: 'center', display: 'flex', flexDirection: 'column' }}>
              ...
              <p style={{ fontSize: '0.875rem', color: 'var(--sub-text)', marginBottom: '24px', flex: 1 }}>가입 대기 중인 학생 승인</p>
            ...
            <div className="card" style={{ border: '1px solid var(--border)', textAlign: 'center', display: 'flex', flexDirection: 'column' }}>
              ...
              <p style={{ fontSize: '0.875rem', color: 'var(--sub-text)', marginBottom: '24px', flex: 1 }}>OPEN LAB 신청 현황</p>
            ...
            <div className="card" style={{ border: '1px solid var(--border)', textAlign: 'center', display: 'flex', flexDirection: 'column' }}>
              ...
              <p style={{ fontSize: '0.875rem', color: 'var(--sub-text)', marginBottom: '24px', flex: 1 }}>공지사항 관리</p>
              <Link href="/admin/notices" className="btn-outline" style={{ width: '100%', textAlign: 'center' }}>관리하기</Link>
            </div>
            <div className="card" style={{ border: '1px solid var(--border)', textAlign: 'center', display: 'flex', flexDirection: 'column' }}>
              <h3 style={{ fontSize: '1rem', marginBottom: '8px', fontWeight: '700' }}>일일 출석 및 정리 관리</h3>
              <p style={{ fontSize: '0.875rem', color: 'var(--sub-text)', marginBottom: '24px', flex: 1 }}>일자별 출석 명단 확인 및 인쇄</p>
              <Link href="/admin/attendance" className="btn-accent" style={{ width: '100%', textAlign: 'center' }}>출석부 확인</Link>
            </div>
            <div className="card" style={{ border: '1px solid var(--border)', textAlign: 'center', display: 'flex', flexDirection: 'column' }}>
              <h3 style={{ fontSize: '1rem', marginBottom: '8px', fontWeight: '700' }}>운영시간 관리</h3>
              <p style={{ fontSize: '0.875rem', color: 'var(--sub-text)', marginBottom: '24px', flex: 1 }}>학년별 OPEN LAB 운영 시간</p>
